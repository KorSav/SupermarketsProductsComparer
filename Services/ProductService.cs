...
)
{
    ...
    public async Task<PaginatedList<Product>> FindProductsByQueryAsync(User user, string query, int pageNo, int pageSize, SortBy sortBy = SortBy.Name, SortOrderId sortOrder = SortOrderId.Asc)
    {
